...
def print_menu():
    ...
    print("   Current issue: Using older embed-english-v2.0 model")
    print()
...
def show_help():
    ...
    print("   • Problem: Using 'embed-english-v2.0' (older model)")
    print("   • Impact: Lower quality embeddings, poor retrieval")
    print("   • Location: app/rag_pipeline.py, _generate_embeddings method")
    print("   • Fix: Try 'embed-english-v3.0' or newer models")
    print()
